<template>
  <section>
    <section class="section">
      <div class="my-3 py-6" />
      <div class="container">
        <img src="~/assets/img/justa-quienes-somos-logo.svg" width="350" class="image is-centered">
    ...
    <div class="section">
      <div class="container">
        <div class="columns is-centered">
          <div class="column is-6">
            <h1 class="title is-2">
              Temas <span class="has-text-weight-bolder has-special-blue is-900">prioritarios</span> de la plataforma
            </h1>
            <div class="line" />
          </div>
        </div>
...
<style lang="scss" scoped>
  ...
  .hero.is-special{
    background-color: rgba(159, 94, 183, 0.1);
  }
  .has-special-blue-bg{
    background: #DAE5FD;
  }
