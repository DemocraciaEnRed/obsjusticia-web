    ...
    <div class="columns">
      <div class="column is-three-quarters">
        <div class="container">
          ...
          <div v-for="parrafo in post.parafos" :key="`parrafo-${parrafo.titulo}`" class="is-size-4 my-6">
            <p class="is-size-3 has-text-weight-bold my-3">
              {{ parrafo.titulo }}
            </p>
            <p>
              {{ parrafo.contenido }}
      ...
      <div class="column mb-6">
        <div class="container">
          <div class="box has-background-white py-6 mt-6 mx-6">
